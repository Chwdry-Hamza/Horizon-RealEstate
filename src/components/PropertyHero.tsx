    ...
    <section className="relative bg-[#1a1a1a] py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8">
        <div className="flex items-end justify-between">
          ...
          <div>
            {/* Main Heading */}
            <h1 className="text-white text-5xl md:text-6xl lg:text-7xl font-light mb-12">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 bg-transparent border border-gray-600 rounded-lg px-6 py-4 text-white hover:border-gray-400 transition-colors min-w-50"
                >
                  ...
                  <div className="absolute top-full left-0 mt-2 w-full bg-[#2a2a2a] border border-gray-600 rounded-lg overflow-hidden z-50">
                    {locations.map((location) => (
                      <button
                        ...
                        className="w-full text-left px-6 py-3 text-white hover:bg-[#3a3a3a] transition-colors"
                      >
                        {location}
                      </button>
                    ))}
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 bg-transparent border border-gray-600 rounded-lg px-6 py-4 text-white hover:border-gray-400 transition-colors min-w-45"
                >
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                  <span className="text-white">{selectedProperty}</span>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-3 bg-transparent border border-gray-600 rounded-lg px-6 py-4 text-white hover:border-gray-400 transition-colors min-w-40"
                >
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Search Button */}
              <button className="bg-[#af8e5b] hover:bg-[#9a7d4f] text-white font-medium px-8 py-4 rounded-lg transition-colors">
                Search
              </button>
            </div>
          </div>
          ...
          {/* Right Badge */}
          <div className="relative w-32 h-32 md:w-36 md:h-36 shrink-0 group">
